function NPC( MapControl, Name, x, y, direction, sheet_type, sheet_name, dialog ) {
	this.OnCreate( MapControl, Name, x, y, direction, sheet_type, sheet_name, dialog ) ;
	return this ;
} // NPC() 

// NPC角色建立
NPC.prototype.OnCreate = function( MapControl, Name, x, y, direction, sheet_type, sheet_name, dialog ) {
	// Magic Number !!
	this.spriteSize = 125 ;
...
NPC.prototype.Clone = function() {
	var cloneContainer = new NPC( this.MapControlPointer, this.name, this.container.grid_x, this.container.grid_y, this.direction, this.sheet_type, this.sheet_name, this.dialog ) ;
