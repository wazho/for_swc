function Main_Framework( len, hei ) {
	...
	this.marquee.text = new createjs.Text( "This editor is made by Salmon on -> https://github.com/grass0916/Stardust-Script    my site : http://salmon.tw", "25px Arial", "#FFF" ) ;
...
Main_Framework.prototype.OnInventory = function() {
	this.img = new Image() ;
    this.img.src = "skin/skin_01/box.png" ;
...
Main_Framework.prototype.OnSkillTree = function() {
	...
	for ( i = 0 ; i < 10 ; i ++ ) {
		...
		skill_img[i].src = "pic/skill/null.png" ;
	} // for
	...
	skill_img[0].src = "pic/skill/heal.png" ;
	skill_img[1].src = "pic/skill/increase_agility.png" ;
	skill_img[2].src = "pic/skill/blessing.png" ;
	skill_img[3].src = "pic/skill/blessing.png" ;
...
Main_Framework.prototype.OnCondition = function() {
	...
	for ( i = 0 ; i < 10 ; i ++ ) {
		...
		buff_img[i].src = "pic/skill/null.png" ;
	} // for
	buff_img[0].src = "pic/skill/increase_agility.png" ;
